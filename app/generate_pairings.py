...
def calculate_food_attributes(average_food_embedding, food_average_distances):
    tastes_weights = {
    ...
    for taste in core_tastes:
        ...
        similarity = spatial.distance.cosine(
            food_average_distances[taste]["average_vec"], average_food_embedding
        )  # type: ignore
        # scale the similarity using our minmax scaler
        scaled_similarity = minmax_scaler(
            similarity,
            food_average_distances[taste]["closest"],
            food_average_distances[taste]["farthest"],
        )
...
def get_food_attributes(food_ingredients):
    ...
    food_attributes = calculate_food_attributes(
        food_tastes_distances.get("aroma"), food_average_distances
    )
